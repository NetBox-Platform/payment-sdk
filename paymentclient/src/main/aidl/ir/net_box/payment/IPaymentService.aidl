...
interface IPaymentService {
    ...
    Bundle purchaseProductVatExclusive(String sourceSku, String userId, String purchaseToken, String identifier, String payload, String packageName, int price, int discount, int productType, String titleFa, String titleEn, String titleAr, String titleTr);
