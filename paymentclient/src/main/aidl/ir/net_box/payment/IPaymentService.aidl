...
interface IPaymentService {
    ...
    Bundle purchaseProduct(String sourceSku, String userId, String purchaseToken, String identifier, String payload, String packageName, int price, int discountedPrice, int vat, int productType, String titleFa, String titleEn, String titleAr, String titleTr);
